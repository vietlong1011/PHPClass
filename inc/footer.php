   ...
   <div class="footer">
	     ...
	     <div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Liên hệ</h4>
						<ul>
							<li><span>67896789</span></li>
							<li><span>12345678</span></li>
						</ul>
						<div class="social-icons">
							<h4>Theo dõi chúng tôi</h4>
					   		  <ul>
							      <li class="facebook"><a href="https://www.facebook.com/" target="_blank"> </a></li>
							      <li class="twitter"><a href="https://www.facebook.com/" target="_blank"> </a></li>
							      <li class="googleplus"><a href="https://www.facebook.com/" target="_blank"> </a></li>
							      <li class="contact"><a href="https://www.facebook.com/" target="_blank"> </a></li>
							      <div class="clear"></div>
						     </ul>
   	 					</div>
				</div>
